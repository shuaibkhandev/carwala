                    ...
                    {loading ? (
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-3 col-md-4 col-sm-6 showcase_card">
                                <img
                                    decoding="async"
                                    src={`http://localhost:8000/images/${brand?.brandPictures}`}
            ...
            <div className="container">
                <div className="row" style={{ marginBottom: '100px', marginTop: '-40px' }}>
                    ...
                    {Array.isArray(brand?.carInvoleInThisBrand) ? (
                        brand?.carInvoleInThisBrand?.map((p, idx) => (
                            <div key={idx} className="col-md-12 col-lg-3 mb-3 mb-lg-0 my-3">
                                <div className="card">
                                    <div className="d-flex justify-content-between p-3">
                                        ...
                                        >
                                            <p className="text-white mb-0 small">
                                                <img
                                                    src={`http://localhost:8000/images/${p?.brand?.brandPictures}`}
                                                    alt={brand?.name}
